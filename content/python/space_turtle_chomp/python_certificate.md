  ...
  <form method="POST" action="https://shecodes.activehosted.com/proc.php" id="_form_17_" class="_form _form_17 _inline-form _inline-style _dark" novalidate data-styles-version="5">
    ...
    <div class="_form-content">
      ...
      <div class="_button-wrapper _inline-style">
        <input id="_form_17_submit" class="_submit" type="submit"  value="Download" >
        </input>
      </div>
...
document.getElementById("_form_17_submit").addEventListener('click', function(){
...
image.src = "../images/python_certificate.png";
